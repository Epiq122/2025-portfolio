      ...
      <div className='max-w-3xl mx-auto px-4'>
        ...
        <div className='rouned-xl p-8 border-white/10 border hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(192,132,252,0.4)] transition-all duration-300'>
          <p className='text-gray-00 text-lg mb-8'>
            ...
            efficient web applications for both small and big business, to bring
            there ideas to life.
          </p>
            ...
            <div className='space-y-4 text-gray-300'>
              <div>
                <h4 className='font-semibold'>
                  Full Stack library booking app for coderscampus final project
                  (2022)
                </h4>

                <p className='text-gray-400 mt-2'>
                  Developed a full stack application, built with React and
                  Springboot and a MySQL database, complete with user login and
                  admin panel as well as a rating system and a review section
                </p>
              </div>
            </div>
          </div>
